"""
Django settings for app_38903 project.
...
WSGI_APPLICATION = 'app_38903.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_38903 API",
    "DESCRIPTION": "API documentation for app_38903 App",
    "VERSION": "v1",
}
